...
class _CardsView extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    // SINO APARECE UNA GRAFICA AMARILLA Y NEGRA EN EL EMULADOR ES PORQUE SE DESBORDO
    // EL SCREEN DE TANTOS ELEMENTOS Y NO CABEN, PARA ESO USO SINGLECHILDSCROOLVIEW
    return SingleChildScrollView(
      child: Column(
        children: [
          ...
          // LA IDEA DE ESTO ES QUE EL ULTIMO WIDGET QUE SE MUESTRE SEA ESTE
          // PARA QUE QUEDE UN ESPACIO AL FONDO DE LA LISTA
          const SizedBox(
            height: 30,
          )
        ],
...
class _CardType4 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Card(
        // ESTE CLIP EVITA QUE LOS HIJOS SE SALGAN DE SU CONTENIDO
